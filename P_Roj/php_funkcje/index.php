    ...
    <main>
        ...
        if(isset($_POST['podciag'])){
            if(strpos($_POST['ciag'],$_POST['podciag_tekst'])!== false){
                echo "<h1>Podciąg ".$_POST['podciag_tekst']." został znaleziony</h1>";
            }else{
                echo "<h1>Podciąg ".$_POST['podciag_tekst']." nie został znaleziony</h1>";
            }
        }
        ?>
        <form method="post">
        ...
        if (isset($_POST['fragment'])) {
            echo "<h1>Fragment: " . substr($_POST['ciag_fragment'], ($_POST['pozycja_poczatkowa']-1), $_POST['dlugosc']) . "</h1>";
        }
        ?>
        <form method="post">
        ...
        if (isset($_POST['replace'])) {
            echo "<h1>" . str_replace($_POST['stare'], $_POST['nowe'], $_POST['text']) . "</h1>";
        }
        ?>
        <form method="post">
            <input type="text" name="text" placeholder="Podaj tekst">
        ...
        <?php
        if (isset($_POST['trim'])) {
            echo "<h1>Oczyszczony tekst: '" . trim($_POST['text'], $_POST['text_usuniecie']) . "'</h1>";
        }
        ?>
        <form method="post">
            <input type="text" name="text" placeholder="Podaj tekst">
        ...
        if (isset($_POST['wielkosc'])) {
            echo "<h1>Wielkie litery: " . strtoupper($_POST['text']) . "</h1>";
            echo "<h1>Małe litery: " . strtolower($_POST['text']) . "</h1>";
        }
        ?>
        <form method="post">
            <input type="text" name="text" placeholder="Podaj tekst">
