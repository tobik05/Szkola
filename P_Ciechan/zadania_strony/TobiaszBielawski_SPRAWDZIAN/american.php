...
<body>
    ...
    <section class="blok_glowny">
        ...
        //skrypt 2
        $con=mysqli_connect("localhost","root","","hodowla");
        $zapytanie=mysqli_query($con,"SELECT DISTINCT data_ur, miot, rasa FROM swinki JOIN rasy on rasy_id=rasy.id where rasy.id=6;");
        ...
        <?php 
        //skrypt 3
        $zapytanie_2=mysqli_query($con,"SELECT imie, cena, opis from swinki where rasy_id=6;");
